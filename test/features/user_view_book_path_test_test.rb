...
class UserViewBookPathTestTest < Capybara::Rails::TestCase
  setup do
    author = Author.create! first_name: "Anthony", last_name: "Burgees"
    Book.create!  title: "A Clockwork Orange", price: 34, photo_url: "https://upload.wikimedia.org/wikipedia/en/2/23/Clockwork_orange.jpg", author_id: author.id
